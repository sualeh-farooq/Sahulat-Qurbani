...
const HairCare = () => {
  ...
  const hairCareProducts = shop_data.filter(item => item.category === "haircare");
            ...
            <div className="row align-items-center">
              <div className="col-lg-12 col-md-7 col-12">
                <div className="text-center " >  
                  <h2 className="text-white " >Hair Care Products</h2>
                  <p className="text-white">Nourish and Transform Your Hair with Our Expertly Crafted Solutions</p>
                </div>
              </div>
            </div>
          </div>
