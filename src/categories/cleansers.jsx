...
const Creamss = () => {
  ...
  const FACEWASHes = shop_data.filter(item => item.category === "FACE WASH");
            ...
            <div className="row align-items-center">
              <div className="col-lg-12 col-md-7 col-12">
                <div className="text-center " >  
                  <h2 className="text-white " >Face Washes & Creams</h2>
                  <p className="text-white">Revitalize Your Skin with Our Expertly Formulated Solutions</p>
                </div>
              </div>
            </div>
          </div>
