...
const Serums = () => {
  ...
  const serumProducts = shop_data.filter(item => item.category === "serum");
            ...
            <div className="row align-items-center">
              <div className="col-lg-12 col-md-7 col-12">
                <div className="text-center " >  
                  <h2 className="text-white " >Skincare Serums</h2>
                  <p className="text-white">Elevate Your Skincare Routine with Expertly Formulated Serums</p>
                </div>
              </div>
            </div>
          </div>
