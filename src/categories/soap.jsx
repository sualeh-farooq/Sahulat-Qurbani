...
const Soap = () => {
  ...
  const soapProducts = shop_data.filter(item => item.category === "soap");
            ...
            <div className="row align-items-center">
              <div className="col-lg-12 col-md-7 col-12">
                <div className="text-center " >  
                  <h2 className="text-white " >Soap Bars</h2>
                  <p className="text-white">Indulge in the Luxury of Nourishing Cleansing for Your Skin</p>
                </div>
              </div>
            </div>
          </div>
